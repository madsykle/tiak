            ...
            {jobs.map((job) => (
              ...
              <tr key={job.id} className="hover:bg-surface-subtle/50 transition-colors">
                ...
                <td className="px-4 py-3">
                  <span className="inline-flex items-center rounded-md bg-surface-strong px-2 py-1 text-xs font-medium text-foreground ring-1 ring-inset ring-white/10">
                ...
                <td className="px-4 py-3 max-w-[200px]">
                  <div className="flex flex-col">
                    {job.creator_name && <span className="font-medium text-xs text-foreground">{job.creator_name}</span>}
                    {job.caption && <span className="text-[10px] text-content-muted truncate" title={job.caption}>{job.caption}</span>}

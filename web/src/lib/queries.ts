...
export function useRetryJob() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const res = await fetchWithAuth(`${API_BASE}/queue/retry/${id}`, { method: 'POST' });
...
export function useRedownloadJob() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const res = await fetchWithAuth(`${API_BASE}/queue/redownload/${id}`, { method: 'POST' });
...
export function useDeleteJob() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const res = await fetchWithAuth(`${API_BASE}/queue/${id}`, { method: 'DELETE' });
...
export function useMoveFile() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({ path, newCategory, jobId }: { path?: string; newCategory: string; jobId?: string }) => {
...
export function useDeleteCategory() {
  ...
  return useMutation({
    mutationFn: async (name: string) => {
      const res = await fetchWithAuth(`${API_BASE}/categories/${name}`, { method: 'DELETE' });
...
export function useSearch(q: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await fetchWithAuth(`${API_BASE}/videos/search?q=${encodeURIComponent(q)}`);
...
export function useByCategory(name: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await fetchWithAuth(`${API_BASE}/videos/category/${encodeURIComponent(name)}`);
...
export function useByCreator(name: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await fetchWithAuth(`${API_BASE}/videos/creator/${encodeURIComponent(name)}`);
...
export function useRunSync() {
  return useMutation({
    mutationFn: async () => {
      const res = await fetchWithAuth(`${API_BASE}/sync/run`, { method: 'POST' });
